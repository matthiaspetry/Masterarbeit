...
model = YOLO("/home/localedge2/Masterarbeit/models/Yolov8_best.pt")
model.to("cuda")
state_dict = torch.load("/home/localedge2/Masterarbeit/models/fastvit37_t8.pth",map_location=torch.device('cuda'))
...
while True:
    ...
    results = model.predict(resized_frame, verbose=False, imgsz=512,device="0")
    ...
    for result in results:
        ...
        for i, cls in enumerate(classes):
            if cls == 7:
                ...
                img_batched= img_batched.to("cuda")
                bbox_tensor = bbox_tensor.to("cuda")
